 ...
 <?php
     ...
     if(isset($_POST["submit"]))
     {
      ...
      $result = mysqli_query($mysqli,"INSERT into crop_management(id,Enter_crop_name,Date_of_production,Production_Amount,Total_Production_till_date,userid) values('$id', '$Enter_crop_name','$Date_of_production','$Production_Amount','$Total_Production_till_date','$id')");
