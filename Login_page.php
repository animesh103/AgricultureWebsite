 ...
 include("functions.php");
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
    {
      ...
      echo "<p><br><br><br><br><i><div align='center' style='background-color: red; width: 50%; text-align: center; display: block; margin: auto'><font color=white size='5px'>wrong username or password!</font></div></i></br></br></br></br></p>";
    }else
    {
